...
# this class is responsible for building QuerySet objects associated with Person.
...
# this class is responsible for building QuerySet objects associated with Vote.
